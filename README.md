...
![PHP Version](https://img.shields.io/badge/php-%3E%3D%207.x-777BB4.svg)
![MySQL](https://img.shields.io/badge/mysql-%3E%3D%205.7-blue.svg)
...
### Key Highlights
- 🔒 **Enterprise-grade security** with password hashing (`PASSWORD_DEFAULT`), input sanitization, and prepared statements
...
├── login_choice.php                 # Login type selector
...
├── manage_books.php                 # Inventory management
├── manage_orders.php                # Order management
├── manage_inventory.php             # Stock management
├── admin_analytics.php              # Sales analytics & reports
│
├── search_suggest.php               # AJAX search suggestions
├── insert_books_script.php          # Book data seeding
│
├── bookshop_db.sql                  # Full database schema
...
cd lamp-shade-bookshop-management-system
```

**2. Import the Database Schema**
```bash
mysql -u root -p < bookshop_db.sql
```
...
```bash
C:\xampp\htdocs\lamp-shade-bookshop-management-system\
```
...
| `generate_receipt.php` | Download/print order receipt |

### 🔧 Admin Journey
| Page | Purpose |
|:---|:---|
| `admin_login.php` | Admin authentication |
| `admin_dashboard.php` | Main admin control center |
| `manage_books.php` | Add, edit, delete books |
| `manage_orders.php` | Process and track orders |
| `manage_inventory.php` | Monitor stock levels |
| `admin_analytics.php` | Sales analytics & reports |
...
3. **Commit your changes**
   ```bash
   git commit -m 'Add YourAmazingFeature with description'
   ```
...
See `LICENSE.txt` for detailed terms.

---

## Contact

**Zawed Bin Tariq** 📧 Email: zawed.tariq@northsouth.edu  
🔗 GitHub: [@zrohan-enter](https://github.com/zrohan-enter)  
📂 Project: lamp-shade-bookshop-management-system  
...
- Best README Template - README style inspiration
- Bootstrap Framework - UI components
...
[Back to Top](#-lamp-shade-bookshop-management-system)
</div>
